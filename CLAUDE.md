...
> 二开文档统一放 `docs/customization/<YYYYMMDD-子任务>/` 下（子任务名带日期），例：
> 📄 [`docs/customization/20260826-init/实现细节.md`](docs/customization/20260826-init/实现细节.md)　·　[`开发进度.md`](docs/customization/20260826-init/开发进度.md)　·　[`最终报告.md`](docs/customization/20260826-init/最终报告.md)
